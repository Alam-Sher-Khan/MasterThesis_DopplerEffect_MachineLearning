...
directory_path = "C:/My_Docs/GERMANY/ALAM/Frankfurt/Studies/4_Sem/My_Thesis/Readings/Headers_separated_ADC/Object/Standing/Test"  # Replace with actual directory path
...
for filename in os.listdir(directory_path):
    if filename.endswith(".txt") and 'adc' in filename:
        ...
        for row in range(adc_data.shape[0]):
            ...
            # Plot frequency spectra with features
