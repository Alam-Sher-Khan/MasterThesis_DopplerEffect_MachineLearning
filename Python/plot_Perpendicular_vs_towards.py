...
metrics_scenario1 = [0.56, 0.56, 0.56, 0.56]  # Example values for accuracy, precision, recall, f1 score
...
scenario1_name = 'MLP Model Trained on Perpendicular Dataset(Non-Doppler) for classifying Moving Towards Dataset(Doppler)'
